...
public class PlayerCtrl : MonoBehaviour {
    ...
    private bool col_check=true;//이동 판단변수
    private bool jumpcnt = false;//점프 판단변수
    private bool slidecnt = false;//슬라이드 판단변수
    private float Slidetime = 0.7f;//슬라이딩 시간
    ...
    void Awake()
    {
        ...
        tempGO[9] = GameObject.Find("Trap10");
    }
